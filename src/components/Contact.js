  ...
  return <section className='py-16 lg:section' id='contact'>
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row'>
        ...
        > 
          <div>
            <h4 className='text-x1 uppercase text-accent font-medium mb-2 tracking-wide'>Get in touch with me</h4>
        ...
        <motion.form 
          ...
          <textarea className='bg-transparent border-b py-12 outline-none w-full placeholder:text-white
           ...
           <button className='btn btn-lg btn-center'>Send message</button>
        </motion.form>
      </div>
    </div>
    </section>;
